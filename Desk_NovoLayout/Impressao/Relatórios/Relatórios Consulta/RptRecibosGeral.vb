...
Public Class RptRecibosGeral
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "tela_inicial.RptRecibosGeral.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptRecibosGeral
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptRecibosGeral = New RptRecibosGeral()
        rpt.Site = Me.Site
        Return rpt
    End Function
