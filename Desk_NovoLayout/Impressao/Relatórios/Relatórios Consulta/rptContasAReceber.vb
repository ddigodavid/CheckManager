...
Public Class rptContasAReceber
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "tela_inicial.rptContasAReceber.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptContasAReceber
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptContasAReceber = New rptContasAReceber()
        rpt.Site = Me.Site
        Return rpt
    End Function
