...
Public Class rptClientes1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "tela_inicial.rptClientes1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptClientes1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptClientes1 = New rptClientes1()
        rpt.Site = Me.Site
        Return rpt
    End Function
