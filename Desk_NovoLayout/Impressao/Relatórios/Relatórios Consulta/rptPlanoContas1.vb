...
Public Class rptPlanoContas1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "tela_inicial.rptPlanoContas1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPlanoContas1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPlanoContas1 = New rptPlanoContas1()
        rpt.Site = Me.Site
        Return rpt
    End Function
