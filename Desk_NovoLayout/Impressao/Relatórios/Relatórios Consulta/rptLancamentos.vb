...
Public Class rptLancamentos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "tela_inicial.rptLancamentos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLancamentos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLancamentos = New rptLancamentos()
        rpt.Site = Me.Site
        Return rpt
    End Function
