...
Public Class rpt2viaRecibos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "tela_inicial.rpt2viaRecibos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt2viaRecibos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt2viaRecibos = New rpt2viaRecibos()
        rpt.Site = Me.Site
        Return rpt
    End Function
